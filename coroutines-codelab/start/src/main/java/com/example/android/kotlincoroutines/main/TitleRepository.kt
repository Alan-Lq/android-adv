...
class TitleRepository(val network: MainNetwork, val titleDao: TitleDao) {
     ...
     */
    val title: LiveData<Call<String>?> = titleDao.titleLiveData.map { it?.title }
    ...
    suspend fun refreshTitle()
    {
        ...
        {
            //if anything throws exception , inform the caller
            throw TitleRefreshError("Unable to refersh title" , cause)
        }
